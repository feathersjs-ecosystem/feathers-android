...
public abstract class IFeathersProvider <T> extends IFeathersConfigurable {
    ...
    public abstract <J> void find(Map<String, String> params, FeathersService.FeathersCallback<Result<J>> cb);

    public abstract <J> void get(String id, FeathersService.FeathersCallback<J> cb);

    public abstract <J> void remove(String id, FeathersService.FeathersCallback<J> cb);

    public abstract <J> void create(J item, FeathersService.FeathersCallback<J> cb);

    public abstract <J> void update(String id, J item, FeathersService.FeathersCallback<J> cb);

    public abstract <J> void patch(String id, J item, FeathersService.FeathersCallback<J> cb);
